                    ...
                    help define you. As you grow and learn more about yourself, you can return here to update and reflect on the work you’ve done.</p>
                        ...
                        <div id="social-media-container">
                            ...
                            <div id='bottom-signup'>
                                <FacebookShareButton style={{ textDecoration: 'none' }} to={'/signup'} ><div id="share-bottom-button" ><img id='share-icon' src={facebook} alt='share icon' />Share</div> </FacebookShareButton>
                            </div>
